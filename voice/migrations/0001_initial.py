    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=32, null=True, verbose_name='音频名称')),
                ('likes', models.PositiveIntegerField(default=0, editable=False, verbose_name='喜欢')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET, related_name='voice', to=settings.AUTH_USER_MODEL, verbose_name='音频')),
            ],
            options={
                'db_table': 'Voicefile',
            },
